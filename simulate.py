...
from src.datamodule import SimulateDataModule
from src.module import Regressor
...
def train(
    ...
    # ## LightningDataModule ## #
    lit_datamodule = SimulateDataModule(
        dataset_name=dataset_name,
        batch_size=batch_size
    )

    # ## LightningModule ## #
    lit_module = Regressor(
    ...
    # set logger
    logger = CSVLogger(save_dir=log_dir+f"/{model_name}", name="csv-logs")
    callbacks = [
